...
namespace BOTF3D_GalaxyMap
{
    ...
    public class DrawColliders : MonoBehaviour
    {
        ...
        //public GameObject _systemBoxPrefab;
        //public Vector3 _systemPosition;

        //private void Start()
        //{
        //    GameObject sysBoxCollider = Instantiate(_systemBoxPrefab, _systemPosition, Quaternion.identity) as GameObject;
        //    _mesh = sysBoxCollider.GetComponent<Mesh>();
        //    _material = sysBoxCollider.GetComponent<Material>();
        //}
        //public void Update()
        //{
            ...
            if (AlwaysShowCollider)
            {
                ...
                for (int i = 0; i < _colliders.Length; i++)
                {
                    ...
                    if ((_boxTemp = _temp as BoxCollider) != null)
                    {
                        ...
                        //Gizmos.DrawMesh(tempMesh, _boxTemp.)
                    }
