...
{
	//public class CameraMultiTarget_copy : MonoBehaviour
	//{
	//	public float Pitch;
	//	public float Yaw;
	//	public float Roll;
	//	public float PaddingLeft = 330f;
	//	public float PaddingRight = 330f;
	//	public float PaddingUp = 330f;
	//	public float PaddingDown = 330f;
	//	public float MoveSmoothTime = 0.19f;
	//	private Camera _camera;
	//	public GameObject friend_0;
 ...
 //       public static GameObject _cameraTarget;
 ...
 //           _debugProjection = DebugProjection.ROTATED;
	...
	//	}
	//		//if (GameManager.Instance._statePassedCombatInit) //_targetTimer < 0f)
	//		//{
