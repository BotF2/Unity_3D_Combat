...
namespace Assets.Core
{
    ...
    public class Civilization // has what is unique to a civ
    {
        ...
        #endregion Fields
        public void LoadDictionaryOfCivs(int[] theStars)
            { }
        public void LoadRelationshipDictionaryOfCivs(int[] theStars)
        {

        }  
        public void UpdateCivContactListOnStartCivSelection(TechLevel techLevel)
        {
