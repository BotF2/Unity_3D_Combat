...
namespace Assets.Core
{
    ...
    public class CivManager : MonoBehaviour
    {
        ...
        public static CivData FED;
        public static CivData ROM;
        public static CivData KLING;
        public static CivData CARD;
        public static CivData DOM;
        public static CivData BORG;
        public static CivData TERRAN;
        ...
        public void InitializeCivController(CivController civController, CivSO civSO)
        {
            ...
            civController.civData._shortNameString = civSO.civName;
        }
