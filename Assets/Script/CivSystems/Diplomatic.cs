...
namespace Assets.Core
{
    public class Diplomatic: MonoBehaviour
    {
        ...
        public List<Civilization> FightWithDom;
        ...
        public List<Civilization> FightDom;
        public List<Civilization> FightBorg;
        ...
        public Civilization[] WhoFigthsWithMe(Civilization civ)
        {
            switch (civ)
            {
        ...
        public Civilization[] WhoIsAtWar(Civilization civ)
        {
            switch (civ)
            {
                case Civilization.FED:
